...
<div class="top2">
    ...
    <div class="top-link">
        ...
        <input type="hidden" id="saveCount" value="<%=request.getParameter("saveCount")%>">
        <input type="hidden" id="user_id" value="<%=request.getParameter("rolesid")%>">
    ...
    <div class="top3">
        ...
        <div class="jieguo huiqian"><img src="img/pen0.png" style="width: 20px;height: 20px;position: relative;left: 1%;margin-top:2px;"/>
            ...
            <input type="button" onclick="baocunYorN()" id="bcID" value="保存" class="lastLine_bc1">
            <input type="button" onclick="gotoCancel('b')" value="取消" class="lastLine_qx1">
...
<div id="signature-pad" class="m-signature-pad" style="visibility: hidden; position: fixed; bottom: 50px;">
...
<script type="text/javascript">
    ...
    function gotoCancel (activity) {
        var typeBoot =$("#typeBoot").val();
        if(typeBoot==1){

            window.slifeJsAgent.invoke_native("getResult","params","cancel");
        }else{
