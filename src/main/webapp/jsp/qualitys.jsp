...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1, maximum-scale=3, minimum-scale=0.333333333" />
...
<%--    <script src="js/echarts.min.js"></script>--%>
    ...
    <script type="text/javascript" src="../js/quality/qualityIndex.js"></script>
