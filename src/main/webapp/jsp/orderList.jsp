...
<script type="text/javascript">
                            ...
                            success:function(data){
                                ...
                                if(type==0){ //不需要质检的产品走此节点
                                    ...
                                    $("table.cccc").append(
                                        ...
                                        '<td colspan="5" style="width:240px;text-align: left;">'+data[0].cName+'</td>' +
                                        '<td style="width:125px; text-align: right;">入库数量:&nbsp;&nbsp;</td>'+
                                        '<td style="width:120px;text-align: left;"><input style="width:100px;height:30px;" type="text" id="rksla" oninput="aa(event)" onporpertychange="aa(event)" onkeyup="value=value.replace(/[^\\d.]/g,\'\')"></td></tr>'+
                                        ...
                                        '<td style="width:120px;text-align: left;"><input id="container_time" type="text" placeholder="请选择" style="width:150px;height:30px;cursor:pointer;background-color:#ffffff;" onClick="jeDate({dateCell:\'#container_time\',isTime:true,format:\'YYYY-MM-DD\'})"  readonly></td></tr>'+
                                        '</tr>');
    ...
    function aa(e){
        ...
        var ab= $(" #rksla ").val();
        if(ac ==""|| ac =="0" || isNaN(parseFloat(ac)) ||ab ==""){
